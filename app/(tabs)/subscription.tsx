...
export default function SubscriptionScreen() {
  ...
  const refreshStatus = useCallback(async () => {
    try {
      ...
      console.log('[subscription] Status result:', s);
      setStatus(s);
    } catch (e) {
  ...
  const onOpenPortal = async () => {
    try {
      console.log('[subscription] Opening Stripe billing portal...');
  ...
  const onUpgrade = async () => {
    try {
      console.log('[subscription] Upgrade to yearly clicked');
  ...
  const onSubscribeMonthly = async () => {
    try {
      console.log('[subscription] Start monthly clicked');
  ...
  const onSubscribeYearly = async () => {
    try {
      console.log('[subscription] Start yearly clicked');
  ...
  const onBuyOneOff = async () => {
    try {
      console.log('[subscription] One off reading clicked');
