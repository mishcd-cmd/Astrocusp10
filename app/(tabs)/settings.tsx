...
function looksLikeHiddenAdminText(txt?: string | null) {
  ...
  const s = txt.trim();
  return (
    (/^:?\s*admin/i.test(s) && /duplicate/i.test(s)) ||
    ...
    try {
      ...
      setTimeout(async () => {
        try {
          ...
          console.warn(
            'Failed to refresh subscription after language change:',
            error,
          );
        }
      }, 1000);
            ...
            <View style={styles.menuOptions}>
                ...
                >
                  ...
                  <View style={styles.menuOptionContent}>
                    ...
                    <Text style={styles.menuOptionDescription}>
                      View and edit your cosmic profile, or{' '}
              ...
              >
                ...
                >
                  ...
                  <View style={styles.menuOptionContent}>
                    ...
                    <Text style={styles.menuOptionDescription}>
                      Manage your premium subscription or buy a one off reading
                    </Text>
                  </View>
                </LinearGradient>
              </TouchableOpacity>
              ...
              >
                ...
                >
                  ...
                  <View style={styles.menuOptionContent}>
                    <Text style={styles.menuOptionTitle}>Terms and Conditions</Text>
                    <Text style={styles.menuOptionDescription}>
